    ...
    items: [
      {
        ...
        syllables: ['ba', 'ju'],
        shuffled: ['ju', 'ba'],
        imageSrc: '/images/syllable/baju.png',
        type: 'baju',
      ...
      },
      {
        ...
        syllables: ['bo', 'la'],
        shuffled: ['la', 'bo'],
        imageSrc: '/images/syllable/bola.png',
        type: 'bola',
      ...
      },
      {
        ...
        syllables: ['bu', 'ku'],
        shuffled: ['ku', 'bu'],
        imageSrc: '/images/syllable/buku.png',
        type: 'buku',
      ...
      },
      {
        ...
        syllables: ['ro', 'ti'],
        shuffled: ['ti', 'ro'],
        imageSrc: '/images/syllable/roti.png',
        type: 'roti',
      ...
      },
      {
        ...
        syllables: ['ka', 'sut'],
        shuffled: ['sut', 'ka'],
        imageSrc: '/images/syllable/kasut.png',
        type: 'kasut',
      ...
      },
      {
        ...
        syllables: ['me', 'ja'],
        shuffled: ['ja', 'me'],
        imageSrc: '/images/syllable/meja.png',
        type: 'meja',
    ...
    items: [
      {
        ...
        syllables: ['ke', 're', 'ta'],
        shuffled: ['ta', 'ke', 're'],
        imageSrc: '/images/syllable/kereta.png',
        type: 'kereta',
      ...
      },
      {
        ...
        syllables: ['ke', 'la', 'pa'],
        shuffled: ['pa', 'la', 'ke'],
        imageSrc: '/images/syllable/kelapa.png',
        type: 'kelapa',
      ...
      },
      {
        ...
        syllables: ['to', 'ma', 'to'],
        shuffled: ['ma', 'to', 'to'],
        imageSrc: '/images/syllable/tomato.png',
        type: 'tomato',
      ...
      },
      {
        ...
        syllables: ['ba', 'si', 'kal'],
        shuffled: ['kal', 'ba', 'si'],
        imageSrc: '/images/syllable/basikal.png',
        type: 'basikal',
      ...
      },
      {
        ...
        syllables: ['pe', 'la', 'ngi'],
        shuffled: ['ngi', 'pe', 'la'],
        imageSrc: '/images/syllable/pelangi.png',
        type: 'pelangi',
      ...
      },
      {
        ...
        syllables: ['al', 'ma', 'ri'],
        shuffled: ['ri', 'al', 'ma'],
        imageSrc: '/images/syllable/almari.png',
        type: 'almari',
