...
const AdditionMathIcon = () => (
  ...
  const NUMERACY_GAMES_LIST = [
    ...
    },
    {
      ...
      active: true,
      gameId: 'num_compare',
      numColor: 'from-violet-500 to-purple-600 border-violet-300 text-white',
      titleColor: 'text-violet-600',
      bgHover: 'hover:bg-violet-50/90 hover:border-violet-400 hover:shadow-md',
    ...
    },
    {
      ...
      active: true,
      gameId: 'num_sifir',
      numColor: 'from-orange-400 to-red-500 border-orange-300 text-white',
      titleColor: 'text-orange-600',
      bgHover: 'hover:bg-orange-50/90 hover:border-orange-400 hover:shadow-md',
